...
var Stockfish = /** @class */ (function () {
    ...
    Stockfish.prototype.search = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            var infinite, ponder, searchmoves, basicOptions, command, response, lines, last;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, (last.match(/bestmove[\s]*([a-z,0-9]*)/) || [])[1]];
                }
            });
        });
    };
    ...
    Stockfish.prototype.board = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.do("d", parser_utils_1.endAfterLabel("Checkers"))];
                    case 1:
                        rawResponse = _b.sent();
